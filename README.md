...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-3.0.0-2ecc71?style=flat-square" alt="Version">
...
- Repository files: **79**
- Bash entrypoints/modules/scripts: **27** files, **20847** lines
- Self-test harness: **145** test functions, **10059** lines (runtime assertion totals are reported by the suite, not hardcoded)
