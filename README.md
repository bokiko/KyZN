...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **16086** lines
- Self-test harness: **116** test functions, **7069** lines (runtime assertion totals are reported by the suite, not hardcoded)
