...
- Repository files: **79**
- Bash entrypoints/modules/scripts: **27** files, **20558** lines
- Self-test harness: **142** test functions, **9866** lines (runtime assertion totals are reported by the suite, not hardcoded)
