...
- Repository files: **79**
- Bash entrypoints/modules/scripts: **27** files, **20825** lines
- Self-test harness: **145** test functions, **10037** lines (runtime assertion totals are reported by the suite, not hardcoded)
