...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **15901** lines
- Self-test harness: **115** test functions, **6938** lines (runtime assertion totals are reported by the suite, not hardcoded)
