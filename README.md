...
- Repository files: **76**
- Bash entrypoints/modules/scripts: **25** files, **14284** lines
- Self-test harness: **102** test functions, **5856** lines (runtime assertion totals are reported by the suite, not hardcoded)
