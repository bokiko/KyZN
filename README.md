...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **15022** lines
- Self-test harness: **110** test functions, **6281** lines (runtime assertion totals are reported by the suite, not hardcoded)
