...
- Repository files: **79**
- Bash entrypoints/modules/scripts: **27** files, **20058** lines
- Self-test harness: **141** test functions, **9444** lines (runtime assertion totals are reported by the suite, not hardcoded)
