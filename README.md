...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **15734** lines
- Self-test harness: **114** test functions, **6790** lines (runtime assertion totals are reported by the suite, not hardcoded)
