...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **18989** lines
- Self-test harness: **136** test functions, **9239** lines (runtime assertion totals are reported by the suite, not hardcoded)
