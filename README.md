...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **16011** lines
- Self-test harness: **116** test functions, **7030** lines (runtime assertion totals are reported by the suite, not hardcoded)
