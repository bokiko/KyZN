...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **15535** lines
- Self-test harness: **113** test functions, **6671** lines (runtime assertion totals are reported by the suite, not hardcoded)
