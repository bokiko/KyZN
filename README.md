...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **16089** lines
- Self-test harness: **116** test functions, **7082** lines (runtime assertion totals are reported by the suite, not hardcoded)
