...
- Repository files: **78**
- Bash entrypoints/modules/scripts: **26** files, **16359** lines
- Self-test harness: **117** test functions, **7258** lines (runtime assertion totals are reported by the suite, not hardcoded)
