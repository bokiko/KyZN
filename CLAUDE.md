...
- Repository files: **77**
- Bash entrypoints/modules/scripts: **26** files, **14488** lines
- Self-test harness: **105** test functions, **5982** lines (runtime assertion totals are reported by the suite, not hardcoded)
