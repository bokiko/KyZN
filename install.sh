...
echo -e "    ${CYAN}kyzn init${RESET}  →  ${CYAN}kyzn measure${RESET}  →  ${CYAN}kyzn analyze${RESET}  →  ${CYAN}kyzn improve${RESET}  →  ${CYAN}kyzn approve${RESET}"
echo ""
echo -e "  ${BOLD}Commands:${RESET}"
echo -e "    ${CYAN}kyzn init${RESET}        Set up a project"
echo -e "    ${CYAN}kyzn measure${RESET}     Check project health"
echo -e "    ${CYAN}kyzn analyze${RESET}     Deep multi-agent code analysis"
echo -e "    ${CYAN}kyzn improve${RESET}     AI-powered code improvement"
